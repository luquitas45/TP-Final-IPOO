        ...
        case 2:
            echo "\n== MODIFICAR PASAJERO ==\n";
                ...
                foreach ($pasajeros as $i => $p) {
                    echo "$i. Documento: {$p->getPdocumento()} - {$p->getNombre()} {$p->getApellido()} - Teléfono: {$p->getPtelefono()}\n";
                }
                ...
                $pasajero->setNombre($nombre !== "" ? $nombre : $pasajero->getNombre());
                $pasajero->setApellido($apellido !== "" ? $apellido : $pasajero->getApellido());
                $pasajero->setPtelefono($telefono !== "" ? $telefono : $pasajero->getPtelefono());
